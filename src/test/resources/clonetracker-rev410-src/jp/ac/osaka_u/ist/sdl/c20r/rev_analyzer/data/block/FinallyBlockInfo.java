...
public class FinallyBlockInfo extends BlockInfo {

	private final List<String> caughtExceptionTypes;

	private final String concatenatedCaughtExceptionTypes;

	public FinallyBlockInfo(long ownerRevisionId, long ownerFileId, long id,
		...
		super(ownerRevisionId, ownerFileId, id, BlockType.FINALLY, core, cm,
