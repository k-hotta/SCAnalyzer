...
public class BlockPairDetector {
	...
	public BlockPairDetector(long beforeRevId,
			...
			Map<Long, RetrievedBlockInfo> afterBlocks, BlockPairManager manager) {
	...
	public void processBlocksInChangedFiles() {
		...
		// ブロックの移動追跡処理
		final MovedBlockPairDetector moveDetector = new MovedBlockPairDetector(
				beforeBlocks, afterBlocks);
//		final TraditionalMovedBlockPairDetector moveDetector = new TraditionalMovedBlockPairDetector(
//				beforeBlocks, afterBlocks);
