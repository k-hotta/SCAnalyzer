...
public class Config {
	...
	public CRDMode getCRD_MODE() {
		if (this.cl.hasOption("crd")) {
			if (this.cl.getOptionValue("crd").equalsIgnoreCase("traditional")) {
				return CRDMode.TRADITIONAL;
			}
		}
		return CRDMode.ENHANCED;
	}
